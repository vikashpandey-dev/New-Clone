...
function PhotosTab(props) {
  ...
  async function getPostdata() {
    ...
    if (offset) Object.assign(payload, { page: offset });
  ...
  const handlepagechange = async (item) => {
    ...
    const payload = { page: curoffset, Search: "", Role: "Admin" };
    setOffset(curoffset);
    if (startdate) Object.assign(payload, { startdate: startdate });
    if (enddate) Object.assign(payload, { enddate: enddate });
  ...
  const [minDate, setMinDate] = useState("2023-09-13");

  useEffect(() => {
    // Get the current date
    const currentDate = new Date();

    // Format the current date as "YYYY-MM-DD" (the format required for the input type="date" element)
                    ...
                    <div className="bgF3F9FF p-4 rounded-lg">
                      ...
                      <Card maxW="md" className="mt-3">
                        <CardHeader className="pad-12px">
                          <Flex spacing="4">
                            ...
                            >
                              ...
                              <Box>
                                <Heading size="sm">ICICI BANK</Heading>
                              </Box>
                            </Flex>
                          </Flex>
                        </CardHeader>
                        ...
                        <div className="footer-border flex items-center justify-start">
                          <div
                            className="social-section cursor-pointer"
                            onClick={() => handleopnelike(x)}
                          >
